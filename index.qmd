...
```{python}
from step5_create_masked import create_masked_stipple
masked_stipple = create_masked_stipple(stipple_pattern, block_letter)
```

# Step 6
```{python}
from create_meme import create_statistics_meme
create_statistics_meme(gray_image, stipple_pattern, block_letter, masked_stipple, "my_statistics_meme.png")
```
