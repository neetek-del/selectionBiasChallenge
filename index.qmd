...
print()
print(f"⚠️  This 'S' pattern represents the systematic missing data!")
...
This adds:
- Image dimensions (height, width, total pixels)
- Mask statistics (black letter area vs white background)
- Percentage of the image that will be masked
- A note explaining what the pattern represents

The print statements highlight the selection bias pattern and its impact before it's applied in Step 5.
...
print(f"📊 Stippled Image Statistics:")
...
print(f"📊 Masked Image Statistics:")
...
print()
print(f"⚠️  Selection bias has removed {removed_percentage:.1f}% of the data points!")
print("=" * 50)
print()
